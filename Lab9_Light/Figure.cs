    ...
    public class Figure3D
    {
        ...
        public void SetNormalVectors()
        {
            foreach (var plane in Planes)
                plane.NormalVector = Methods.CrossProduct(Points[plane.PointIndices[1]] - Points[plane.PointIndices[0]],
                    Points[plane.PointIndices[plane.PointIndices.Count - 1]] - Points[plane.PointIndices[0]]);
                    /*Methods.VectorProd(
                    (Points[plane.PointIndices[0]], Points[plane.PointIndices[1]]),
                    (Points[plane.PointIndices[0]], Points[plane.PointIndices[2]]));*/
        }

        public void MarkPlanesAsFaceOrNonFace()
        {
            foreach (var plane in Planes)
                plane.Visible = plane.NormalVector.Z < 0;//Methods.CosBetweenVectors(new Point3D(0, 0, 1), plane.NormalVector) > 0;
